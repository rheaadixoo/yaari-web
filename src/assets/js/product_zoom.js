...
*/
new window["\x46\x75\x6E\x63\x74\x69\x6F\x6E"](
  [
    "r.CloudZoom=d;d.Oa()})(jQuery);;",
    ...
    '(function(e){function s(a){var b=a.zoom,c=a.W,g=a.X;"body"!==b.options.appendSelector&&(c-=b.a.offset().left,g-=b.a.offset().top);var d=a.e,f=a.g;this.data=a;this.A=this.b=null;this.Ea=0;this.zoom=b;this.L=!0;this.s=this.interval=this.B=this.q=0;var q=this,h;q.b=e("<div class=\'"+a.O+"\' style=\'position:absolute;'
  ]
...
function pan(e) {
  ...
  app.$zoomOverlay.css(
    "background-position",
    (e.clientX / W) * 100 + "% " + (e.clientY / H) * 100 + "%"
  );
}
